    ...
    <div class="row top">
        ...
        <div class="col-eight md-six tab-full popular">
            ...
            <div class="block-1-2 block-m-full popular__posts">
				...
				$philosophy_popular_post = new WP_Query( $args );
    ...
    <div class="row bottom tags-wrap">
        <div class="col-full tags">
            ...
            <?php
                ...
                $philosophy_footer_language_terms_tag = apply_filters('philosophy_footer_tag_items',get_tags());
            ?>
            ...
            <div class="tagcloud">
				<?php
                    ...
                    if (is_array($philosophy_footer_language_terms_tag)){
                        foreach ($philosophy_footer_language_terms_tag as $list){
                            printf("<a href='%s'>%s</a>",get_term_link($list->term_id),$list->name);
                        }
                    }
                ?>
            </div> <!-- end tagcloud -->
